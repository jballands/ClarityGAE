...
(function() {
  var apiCall, consoleLogout, dataCreateRecord, dataCreateSubmitRecord, dataDeleteRecords, dataDetailRecord, dataFilterAdd, dataFilterChange, dataFilterRemove, dataInitButtons, dataLoadTable, dataMakeDetailView, dataMakeTableView, dataModalTicketClose, dataModeAdvanced, dataModeNormal, dataPageBack, dataPageButton, dataPageForward, dataParseTable, initialize, root;
  ...
  initialize = function() {
    ...
    ($("#data_buttonQuery")).click(function() {
      return dataLoadTable();
    });
  ...
  dataModeNormal = function() {
    ($("#data_divModeNormal")).show();
    ($("#data_divModeAdvanced")).hide();
    ($("#data_queryText")).val("");
    root.dataAdvancedMode = false;
    return dataLoadTable();
  };

  dataModeAdvanced = function() {
    ($("#data_divModeNormal")).hide();
    ($("#data_divModeAdvanced")).show();
    root.dataFilters = {};
    ($("data_filterList")).children().remove();
